...
\begin{Huge}
\color{red}
\Ovalbox{Édition \begin{WINDOWS}Windows\end{WINDOWS}\begin{LINUX}Linux\end{LINUX}\begin{MAC}Mac Os X\end{MAC}}
\Ovalbox{Édition Windows}
\end{Huge}
\color{black}
\rm
\end{flushleft}
...
\AddToShipoutPicture*{
 ...
 \vspace{2cm}
\begin{flushleft}
\hspace*{0cm}\includegraphics[width=20cm]{images/couv.png}
\end{flushleft}
 \vfill
 }}}
