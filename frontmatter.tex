...
\url{http://openclipart.org} et \url{http://commons.wikimedia.org}. L'ensemble des illustrations créées ou modifiées pour la traduction ont été faites en utilisant \emph{the GIMP} et \emph{Inkscape}.
