...
Congratulations! Vous venez juste de créer votre premier programme en Python. La commande \index{print}«~\verb+print+~» est une fonction qui écrit tout ce qui est entre les parenthèses sur la sortie de la console, nous la verrons plus en détail ultérieurement.
