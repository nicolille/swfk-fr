...
Rappelez-vous: ne confondez pas les \emph{deux} symboles égal utilisés dans une condition «~\texttt{==}~», avec le signe égal utilisé pour assigner une variable. Si vous utiliser un seul symbole «~\texttt{=}~» dans une condition, vous obtiendre un mesage d'erreur.\end{minipage}}
\\
