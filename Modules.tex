...
\subsection{Le module «~\texttt{random}~»}\index{modules!random}
...
\subsection*{Le module «~\texttt{sys}~»}\index{modules!sys}
...
\subsection*{Le module «~\texttt{locale}~»}\index{modules!locale}
...
\subsection*{Le module «~\texttt{time}~»}\index{modules!time}
